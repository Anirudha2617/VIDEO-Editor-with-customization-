...
import { Code, Image as ImageIcon, Video, Type, Play, Save, Trash2, Edit2, Loader2, Download, Sparkles, Plus, ImagePlus } from 'lucide-react';
                    ...
                    <div className="flex-1 overflow-y-auto custom-scrollbar p-3 space-y-4">
                        {activeTab === 'create' ? (
                            <>
                                ...
                                {/* Editor Section */}
                                <div className="border border-[#3f3f46] rounded-md overflow-hidden flex flex-col h-[280px]">
