...
export const generateScript = (tracks: Track[], clips: Clip[], assets: Asset[]): string => {
...
export const parseScript = (script: string, currentAssets: Asset[], currentTracks: Track[]): ParseResult => {
